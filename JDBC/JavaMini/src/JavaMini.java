	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					pst = con.prepareStatement("insert into Book(book_name,edition,price)values(?,?,?)");
		...
		btnNewButton.setBounds(10, 135, 77, 23);
		...
		btnClear.setBounds(97, 135, 73, 23);
		panel.add(btnClear);
		...
		textField.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				try {
					...
					pst = con.prepareStatement("select book_name,edition,price from Book where id=?");
					pst.setString(1, id);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					pst = con.prepareStatement("update Book set book_name=?,edition=?,price=? where id=?");
					pst.setString(1,bname);
					pst.setString(2, edition);
					pst.setString(3, price);
					pst.setString(4, bid);
